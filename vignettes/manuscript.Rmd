...
```{r fig3, fig.cap="Soil (a) HCl-extractable and (b) poorly crystalline iron (Fe), as well as soil (c) pH and (d) percent carbon (%C) in recent and parent sediments across the three wetland sites (*n* $\\geq$ 14 per depth). Solid horizontal lines are medians, boxes are the interquartile range (IQR), and whiskers are the 95% confidence interval. Points above each boxplot are the measured soils data for each site.", fig.width=8, fig.height=3, warning=FALSE}
source("R/soils.R") #process soils data into summary dataframe
