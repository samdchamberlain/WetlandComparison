...
a <- ggplot(all_daily, aes(x=date, y=PAR, color=site)) +
  ...
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="a", vjust=1, hjust=1) +
...
b <- ggplot(all_daily, aes(x=date, y=Tair, color=site)) +
  ...
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="b", vjust=1, hjust=1) +
...
c <- ggplot(all_daily, aes(x=date, y=Tw, color=site)) +
  ...
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="c", vjust=1, hjust=1) +
  time_series + theme(axis.text.x = element_blank(), legend.position="none")
...
d <- ggplot(all_daily, aes(x=date, y=WTD, color=site)) +
  ...
  scale_x_date(date_breaks = "1 year", labels = date_format("%Y-%m")) +
  ylab("WTD (cm)") +
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="d", vjust=1, hjust=1) +
...
c <- ggplot(all_daily, aes(x=date, y=gER, color=site)) +
  ...
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="c", vjust=1, hjust=1) +
  times_series + theme(axis.text.x = element_blank(), legend.title=element_blank(), legend.position=c(.92, .85),
                                        legend.margin = margin(0, 0, 0, 0))
...
d <- ggplot(all_daily, aes(x=date, y=mgCH4, color=site)) +
  ...
  annotate("text", x=as.Date("2010-10-01"), y=Inf, label="d", vjust=1, hjust=1) +
  times_series + theme(legend.title=element_blank(), legend.position="none")
...
ggplot(trajectory, aes(x=(dday-365), y=mgCH4, color=site)) +
  ...
  xlab("Day since restoration") + theme(legend.title=element_blank(), legend.position=c(.15, .85),
                                        legend.margin = margin(0, 0, 0, 0))
```
