...
```{r fig6, fig.cap="Methane fluxes (*F~CH4~*) from the young peat and alluvium wetlands for the first three years following restoration. Day zero is 2011-01-1 for the young peat wetland, and 2014-01-01 for the alluvium wetland.", fig.width=4}
...
c <- ggplot(diel_s, aes(x=time, y=ET, color=site)) +
  ...
  time_series + theme(strip.background = element_blank(), strip.text = element_blank(),
                      legend.position = c(0.7,.85), legend.title = element_blank(),
                      legend.margin = margin(0, 0, 0, 0),
                       legend.background = element_rect(fill = "transparent"))
