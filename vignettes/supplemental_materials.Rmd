...
```{r figS1, fig.height = 3, fig.width = 3.5, fig.cap="Soil percent nitrogen (%N) in accreted and parent horizons across the three core wetland sites (*n* $\\geq$ 12 per depth)."}
