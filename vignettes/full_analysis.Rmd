...
## Wetland Time Series
### Met Drivers
```{r figure1, fig.height = 5, fig.width = 8, fig.align = "center",fig.cap="Fig. 1: Meteorological variables across core sites", echo=FALSE, warning=FALSE}
...
```{r figure2, fig.height = 5, fig.width = 8, fig.align = "center",fig.cap="Fig. 2: Daily CH4, GEP, ER, and NEE fluxes across wetland core sites", echo=FALSE, warning=FALSE}
...
Methane fluxes may also be reduced if there is limited SOC available for methanogenesis. This is a distinct possibility because the alluvium soil areas may contain lower SOC. However, we can rule out this hypothesis because there are no significant differences in respiration fluxes across sites (*P* = 0.91), and by 2016 respiration fluxes were somewhat larger from the alluvium site (Fig. 2). If SOC was limiting methanogenesis, we would expect to see similar reductions in annual ER that were observed in CH4 fluxes (Fig. 4). As we do not observe a similar reduction in ER we can logically rule out this hypothesis.
