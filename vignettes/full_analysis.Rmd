...
library(knitr); library(tidyverse); library(lubridate); library(gridExtra); library(scales); library(zoo)
```
...
kable(combined, caption="Mean annual fluxes and site years", digits = 2)
